<template>
    <div class="wrapper">
        ...
        <img src="https://www.sapo.pt/assets/img/bg-placard-01.jpg"
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Về Chúng Tôi</h2>
                <p class="mt-6 text-lg leading-8 text-gray-300">Dịch vụ cho thuê sân bóng trực tuyến giúp người yêu thể thao dễ dàng tìm và đặt sân bóng phù hợp, tiết kiệm thời gian và tạo trải nghiệm thuận lợi cho các đội bóng và cá nhân.</p>
            </div>
...
const links = [
  { name: 'FaceBook', href: '#' },
  { name: 'Gmail', href: '#' },
  { name: 'Dường Dây Nóng', href: '#' }
]
const stats = [
  { name: 'Năm kinh doanh', value: '12' },
  { name: 'Lượt đặt sân mỗi tháng', value: '300+' },
  { name: 'Khung giờ để đặt sân', value: '11' },
