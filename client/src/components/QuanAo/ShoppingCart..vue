      ...
      <Dialog as="div" class="relative z-10" @close="open = false">
        ...
        <div class="fixed inset-0 overflow-hidden">
          <div class="absolute inset-0 overflow-hidden">
            <div
              class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full sm:max-w-md pl-4 sm:pl-10"
            >
              <TransitionChild
                as="template"
              ...
              >
                <DialogPanel class="pointer-events-auto w-screen sm:max-w-md">
                  <div
                    class="content flex h-full flex-col overflow-y-scroll bg-white shadow-xl"
                  >
                    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div class="flex items-start justify-between">
                        <DialogTitle
                          class="text-lg sm:text-xl font-medium text-gray-900"
...
const products = [
  ...
  },
  {
    ...
    quantity: 4,
    imageSrc:
      "https://belo.vn/wp-content/uploads/2018/11/z1188384711253_b6f0da3ac39aa5537f3536ff9e1d82b8.jpg",
  },
];
watch(
  () => props.open,
