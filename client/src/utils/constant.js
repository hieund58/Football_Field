...
export const getNameByCode = (constantCode, value) => {
  switch (constantCode) {
    case 'productType':
      return productTypes?.find(item => item.value === value)?.label;
    case 'productColor':
      return productColors?.find(item => item.value === value)?.label;
    default:
      return '';
  }
};
