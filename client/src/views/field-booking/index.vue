        ...
        <div v-for="field in currentPageFields" :key="field.id" class="group relative">
          ...
          <div class="flex flex-col p-3">
            <div class="text-center">
              <h1 class="md:text-base lg:text-lg font-medium text-gray-1000">
            ...
            <div>
              <p class="md:text-sm lg:text-base">Khu Vực: {{ field.area }}</p>
              <p class="md:text-sm lg:text-base">Sân: {{ field.playerNum }}</p>
              <p class="md:text-sm lg:text-base">Giá: {{ formatMoney(field.price) }}/Trận</p>
            </div>
          </div>
        </div>
      </div>
