<template>
  <div class="w-full h-full">
    ...
    <Bar id="my-chart-id" :options="chartOptions" :data="chartData" class="w-full max-h-[300px]" />
  </div>
</template>
...
const chartData = {
  labels: ['Áo đá Việt Nam', 'Áo đá Pháp', 'Giày Thượng Đình', 'Áo Ronaldo', 'Giày Nike'],
  datasets: [
    {
      axis: 'y',
      data: [90, 82, 80, 70, 56, 55, 40],
      fill: false,
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(255, 159, 64, 0.2)',
