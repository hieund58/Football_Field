      ...
      <div class="mx-auto px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">
            Dịch vụ cho thuê sân bóng trực tuyến giúp người yêu thể thao dễ dàng
            tìm và đặt sân bóng phù hợp, tiết kiệm thời gian và tạo trải nghiệm
            thuận lợi cho các đội bóng và cá nhân.
          </p>
        </div>
